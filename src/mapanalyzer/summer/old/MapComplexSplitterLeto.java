package mapanalyzer.summer.old;
...
/*
 Pre-refactoring monolithic version of the summer semester solution.
 Kept only as an archived reference.
*/
...
public class MapComplexSplitterLeto {
    ...
    */
    public static List<List<Point2D.Double>> splitComplexShape(List<Point2D.Double> points){
        ...
        List<Point2D.Double> polygon = normalizePolygon(points);
